<template>
  <header class="grid md:grid-cols-2 gap-10 items-center py-12" data-aos="fade-up">
      <div class="order-2 md:order-1">
        <h1 class="text-4xl lg:text-6xl leading-tight mb-6 font-sans font-medium">
      ...
      <div class="order-1 md:order-2">
        <div class="relative" data-aos="zoom-in">
          <img src="/images/Illustration.svg" alt="Hero Illustration" class="w-full" />
        </div>
      </div>
    </header>
</template>
